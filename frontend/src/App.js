...
// 替换成后端服务域名
const domain = "https://epmet-test.elinkservice.cn/dingding";
              ...
              axios.get(domain + "/login?authCode=" + result.code)
                .then(response => {
                    ...
                    dd.biz.util.openLink({
                        url:"https://epmet-test.elinkservice.cn/epmet-oper-gov/#/?token="+response.data.data.extension,//要打开链接的地址
                        onSuccess : function(result) {
                            window.close();
                        },
                        onFail : function(err) {}
